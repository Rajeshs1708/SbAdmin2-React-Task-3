...
function Sidebar() {
    ...
    return (
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item">
                ...
                <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div className="bg-white py-2 collapse-inner rounded">
                        ...
                        <Link to="/Components/Buttons" className="collapse-item dropdown-item">Buttons</Link>
                        <Link to="/Components/AllCards" className="collapse-item dropdown-item">Cards</Link>
                    </div > 
            ...
            <li className="nav-item">
                ...
                <div id="collapseUtilities" className="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div className="bg-white py-2 collapse-inner rounded">
                        ...
                        <Link to="/Utilities/Animations">Animations</Link>
                        <Link to="/Utilities/Other">Other</Link>
                    </div>
                </div>
            </li>
            ...
            <li className="nav-item">
                ...
                <div id="collapsePages" className="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div className="bg-white py-2 collapse-inner rounded">
                        ...
                        <Link to="/Pages/BlankPage" className="collapse-item">Blank Page</Link>
                    </div>
                </div>
            </li>
            ...
            <li className="nav-item">
                <Link to="/AllCharts" className="nav-link">
